...
For full example, check the [ScreenshotSampleTest](https://github.com/matzuk/Kaspresso/blob/master/sample/src/androidTest/java/com/kaspersky/kaspressample/docloc_tests/ScreenshotSampleTest.kt). 
...
```
The full example is located at [ChangeSysLanguageTestCase](https://github.com/matzuk/Kaspresso/blob/master/sample/src/androidTest/java/com/kaspersky/kaspressample/docloc_tests/ChangeSysLanguageTestCase.kt).
...
For full example, check [AdvancedScreenshotSampleTest](https://github.com/matzuk/Kaspresso/blob/master/sample/src/androidTest/java/com/kaspersky/kaspressample/docloc_tests/advanced/AdvancedScreenshotSampleTest.kt) class.
