...
#### Device
```Device``` instance. Detailed info is at [Device wiki](https://github.com/matzuk/Kaspresso/wiki/Device)

#### AdbServer
```AdbServer``` instance. Detailed info is at [AdbServer wiki](https://github.com/matzuk/Kaspresso/wiki/AdbServer)
...
The example of how to configure Kaspresso and how to use Kaspresso interceptors are in [configurator](https://github.com/matzuk/Kaspresso/tree/master/sample/src/androidTest/java/com/kaspersky/kaspressample/configurator_tests).
...
The details are at [flakysafety](https://github.com/matzuk/Kaspresso/tree/master/kaspresso/src/main/kotlin/com/kaspersky/kaspresso/flakysafety). <br>
...
The details are at [autoscroll](https://github.com/matzuk/Kaspresso/tree/master/kaspresso/src/main/kotlin/com/kaspersky/kaspresso/autoscroll). <br>
3. Also, Kaspresso attempts to remove all system dialogs if it prevents the test executes. <br>
The details are at [systemsafety](https://github.com/matzuk/Kaspresso/tree/master/kaspresso/src/main/kotlin/com/kaspersky/kaspresso/systemsafety). <br>
