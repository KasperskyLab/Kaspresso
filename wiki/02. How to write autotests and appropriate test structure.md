...
More detailed info about ```Device``` is [here](https://github.com/matzuk/Kaspresso/wiki/03.-Device)
4. ```adbServer``` <br>
...
If you disable this interceptor or if you want to set some special flaky safety params for any view, you can use this method. The example is [here](https://github.com/matzuk/Kaspresso/blob/master/sample/src/androidTest/java/com/kaspersky/kaspressample/flaky_tests/CommonFlakyTest.kt).
6. ```compose``` <br>
...
and as just a regular method (in this case it can take actions on different views as well). The example is [here](https://github.com/matzuk/Kaspresso/blob/master/sample/src/androidTest/java/com/kaspersky/kaspressample/flaky_tests/ComposeTest.kt)

### Examples
You can look at examples of how to [use and configure Kaspresso](https://github.com/matzuk/Kaspresso/tree/master/sample/src/androidTest/java/com/kaspersky/kaspressample/configurator_tests) and use [different forms of dsl](https://github.com/matzuk/Kaspresso/tree/master/sample/src/androidTest/java/com/kaspersky/kaspressample/dsl_tests).