...
open class UpgradeTestCase : TestCase() {
    ...
    companion object {
        ...
        private const val OLD_VERSION_FILE = "/users/matsyuk/desktop/upgrade_test_v1.apk"
        private const val NEW_VERSION_FILE = "/users/matsyuk/desktop/upgrade_test_v2.apk"
    }
