//[kautomator-framework](../../index.md)/[com.kaspersky.components.kautomator.component.chip](../index.md)/[UiChipGroupAssertions](index.md)
...
interface [UiChipGroupAssertions](index.md) : [UiBaseAssertions](../../com.kaspersky.components.kautomator.component.common.assertions/-ui-base-assertions/index.md)   
...
|  Name|  Summary| 
|---|---|
| [UiChipGroupAssertionType](-ui-chip-group-assertion-type/index.md)| [androidJvm]  <br>Content  <br>enum [UiChipGroupAssertionType](-ui-chip-group-assertion-type/index.md) : [Enum](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/index.html)<[UiChipGroupAssertions.UiChipGroupAssertionType](-ui-chip-group-assertion-type/index.md)> , [UiOperationType](../../com.kaspersky.components.kautomator.intercept.operation/-ui-operation-type/index.md)  <br><br><br>
...
| [hasChipWithText](has-chip-with-text.md)| [androidJvm]  <br>Brief description  <br><br><br>Checks if chip with given text exists<br><br>  <br>Content  <br>open fun [hasChipWithText](has-chip-with-text.md)(pattern: [Pattern](https://developer.android.com/reference/kotlin/java/util/regex/Pattern.html))  <br>open fun [hasChipWithText](has-chip-with-text.md)(text: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))  <br><br><br>
| [hashCode](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-any/hash-code.html)| [androidJvm]  <br>Content  <br>open override fun [hashCode](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-any/hash-code.html)(): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)  <br><br><br>
| [isChipWithIdSelected](is-chip-with-id-selected.md)| [androidJvm]  <br>Brief description  <br><br><br>Checks if chip with given id is selected<br><br>  <br>Content  <br>open fun [isChipWithIdSelected](is-chip-with-id-selected.md)(id: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))  <br><br><br>
| [isChipWithIndexSelected](is-chip-with-index-selected.md)| [androidJvm]  <br>Brief description  <br><br><br>Checks if chip with given index is selected<br><br>  <br>Content  <br>open fun [isChipWithIndexSelected](is-chip-with-index-selected.md)(index: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br><br><br>
| [isChipWithTextSelected](is-chip-with-text-selected.md)| [androidJvm]  <br>Brief description  <br><br><br>Checks if chip with given text pattern is selected<br><br>  <br>Content  <br>open fun [isChipWithTextSelected](is-chip-with-text-selected.md)(pattern: [Pattern](https://developer.android.com/reference/kotlin/java/util/regex/Pattern.html))  <br><br><br>[androidJvm]  <br>Brief description  <br><br><br>Checks if chip with given text is selected<br><br>  <br>Content  <br>open fun [isChipWithTextSelected](is-chip-with-text-selected.md)(text: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))  <br><br><br>
...
| [isNotChipWithIdSelected](is-not-chip-with-id-selected.md)| [androidJvm]  <br>Brief description  <br><br><br>Checks if chip with given id is not selected<br><br>  <br>Content  <br>open fun [isNotChipWithIdSelected](is-not-chip-with-id-selected.md)(id: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))  <br><br><br>
| [isNotChipWithIndexSelected](is-not-chip-with-index-selected.md)| [androidJvm]  <br>Brief description  <br><br><br>Checks if chip with given index is not selected<br><br>  <br>Content  <br>open fun [isNotChipWithIndexSelected](is-not-chip-with-index-selected.md)(index: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br><br><br>
| [isNotChipWithTextSelected](is-not-chip-with-text-selected.md)| [androidJvm]  <br>Brief description  <br><br><br>Checks if chip with given text pattern is not selected<br><br>  <br>Content  <br>open fun [isNotChipWithTextSelected](is-not-chip-with-text-selected.md)(pattern: [Pattern](https://developer.android.com/reference/kotlin/java/util/regex/Pattern.html))  <br><br><br>[androidJvm]  <br>Brief description  <br><br><br>Checks if chip with given text is not selected<br><br>  <br>Content  <br>open fun [isNotChipWithTextSelected](is-not-chip-with-text-selected.md)(text: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| [view](index.md#com.kaspersky.components.kautomator.component.chip/UiChipGroupAssertions/view/#/PointingToDeclaration/)|  [androidJvm] abstract override val [view](index.md#com.kaspersky.components.kautomator.component.chip/UiChipGroupAssertions/view/#/PointingToDeclaration/): [UiObjectInteractionDelegate](../../com.kaspersky.components.kautomator.intercept.delegate/-ui-object-interaction-delegate/index.md)   <br>
