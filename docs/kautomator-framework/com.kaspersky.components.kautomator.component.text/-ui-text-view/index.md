//[kautomator-framework](../../index.md)/[com.kaspersky.components.kautomator.component.text](../index.md)/[UiTextView](index.md)
...
class [UiTextView](index.md) : [UiBaseView](../../com.kaspersky.components.kautomator.component.common.views/-ui-base-view/index.md)<[UiTextView](index.md)> , [UiBaseAssertions](../../com.kaspersky.components.kautomator.component.common.assertions/-ui-base-assertions/index.md), [UiTextViewAssertions](../-ui-text-view-assertions/index.md)   
...
| [UiTextViewAssertions](../-ui-text-view-assertions/index.md)| <br><br><br><br>
...
|  Name|  Summary| 
|---|---|
| [UiTextView](-ui-text-view.md)|  [androidJvm] fun [UiTextView](-ui-text-view.md)(selector: [UiViewSelector](../../com.kaspersky.components.kautomator.component.common.builders/-ui-view-selector/index.md))   <br>
| [UiTextView](-ui-text-view.md)|  [androidJvm] fun [UiTextView](-ui-text-view.md)(builder: [UiViewBuilder](../../com.kaspersky.components.kautomator.component.common.builders/-ui-view-builder/index.md).() -> [Unit](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html))   <br>
...
| [hasAnyText](../-ui-text-view-assertions/has-any-text.md)| [androidJvm]  <br>Brief description  <br><br><br>Checks if the view has any text<br><br>  <br>Content  <br>open override fun [hasAnyText](../-ui-text-view-assertions/has-any-text.md)()  <br><br><br>
| [hasEmptyText](../-ui-text-view-assertions/has-empty-text.md)| [androidJvm]  <br>Brief description  <br><br><br>Checks if the view has empty text<br><br>  <br>Content  <br>open override fun [hasEmptyText](../-ui-text-view-assertions/has-empty-text.md)()  <br><br><br>
| [hashCode](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-any/hash-code.html)| [androidJvm]  <br>Content  <br>open override fun [hashCode](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-any/hash-code.html)(): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)  <br><br><br>
| [hasNoText](../-ui-text-view-assertions/has-no-text.md)| [androidJvm]  <br>Brief description  <br><br><br>Checks if the view has not concrete text<br><br>  <br>Content  <br>open override fun [hasNoText](../-ui-text-view-assertions/has-no-text.md)(text: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))  <br><br><br>
| [hasText](../-ui-text-view-assertions/has-text.md)| [androidJvm]  <br>Brief description  <br><br><br>Checks if the view has concrete text<br><br>  <br>Content  <br>open override fun [hasText](../-ui-text-view-assertions/has-text.md)(text: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))  <br><br><br>
...
| invoke| [androidJvm]  <br>Brief description  <br><br><br>Operator that allows usage of DSL style<br><br>  <br>Content  <br>operator override fun invoke(function: [UiTextView](index.md).() -> [Unit](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html))  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| [view](index.md#com.kaspersky.components.kautomator.component.text/UiTextView/view/#/PointingToDeclaration/)|  [androidJvm] override val [view](index.md#com.kaspersky.components.kautomator.component.text/UiTextView/view/#/PointingToDeclaration/): [UiObjectInteractionDelegate](../../com.kaspersky.components.kautomator.intercept.delegate/-ui-object-interaction-delegate/index.md)   <br>
