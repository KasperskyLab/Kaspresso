//[adbserver-common](../../../index.md)/[com.kaspersky.adbserver.common.log.logger](../../index.md)/[LogPolicy](../index.md)/[INFO_ONLY](index.md)



# INFO_ONLY  
 [jvm] [INFO_ONLY](index.md)()  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#com.kaspersky.adbserver.common.log.logger/LogPolicy.INFO_ONLY/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#com.kaspersky.adbserver.common.log.logger/LogPolicy.INFO_ONLY/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#com.kaspersky.adbserver.common.log.logger/LogPolicy.INFO_ONLY/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#com.kaspersky.adbserver.common.log.logger/LogPolicy.INFO_ONLY/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
