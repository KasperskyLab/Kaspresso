//[adbserver-common](../../../index.md)/[com.kaspersky.adbserver.common.log.logger](../../index.md)/[LogPolicy](../index.md)/[DEBUG_FULL](index.md)



# DEBUG_FULL  
 [jvm] [DEBUG_FULL](index.md)()  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#com.kaspersky.adbserver.common.log.logger/LogPolicy.DEBUG_FULL/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#com.kaspersky.adbserver.common.log.logger/LogPolicy.DEBUG_FULL/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#com.kaspersky.adbserver.common.log.logger/LogPolicy.DEBUG_FULL/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#com.kaspersky.adbserver.common.log.logger/LogPolicy.DEBUG_FULL/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
