//[adbserver-common](../../../index.md)/[com.kaspersky.adbserver.common.log.logger](../../index.md)/[LogLevel](../index.md)/[WARN](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#com.kaspersky.adbserver.common.log.logger/LogLevel.WARN/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#com.kaspersky.adbserver.common.log.logger/LogLevel.WARN/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#com.kaspersky.adbserver.common.log.logger/LogLevel.WARN/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#com.kaspersky.adbserver.common.log.logger/LogLevel.WARN/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
