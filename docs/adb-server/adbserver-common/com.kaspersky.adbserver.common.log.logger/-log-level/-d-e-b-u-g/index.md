//[adbserver-common](../../../index.md)/[com.kaspersky.adbserver.common.log.logger](../../index.md)/[LogLevel](../index.md)/[DEBUG](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#com.kaspersky.adbserver.common.log.logger/LogLevel.DEBUG/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#com.kaspersky.adbserver.common.log.logger/LogLevel.DEBUG/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#com.kaspersky.adbserver.common.log.logger/LogLevel.DEBUG/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#com.kaspersky.adbserver.common.log.logger/LogLevel.DEBUG/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
