...
<br> В Android Studio вы можете переключаться между ветками и таким обазом переключаться между разными версиями проекта. Изначально при клонировании проекта вы будете находиться в главной ветке - `master`
