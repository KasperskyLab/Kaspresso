...
<img src="../images/simple_test/simple_test_button.png" alt="Override methods"/>
...
<ol>
    ...
    <li>Если экран не загрузился, то проверьте, что у вас выбран нужный процесс <img src="../images/simple_test/choose_pocess.png" alt="Choose process"/></li>
</ol>
