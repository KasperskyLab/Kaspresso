...
<br> Ранее в консоли мы запускали `adb devices`, которая выводила список подключенных устройств. Давайте запустим эту же команду при помощи теста. Создаем метод `test()` и помечаем аннотацией `@Test`
