//[adbserver-connection](../../index.md)/[com.kaspersky.adbserver.connection.implementation.transferring](../index.md)/[ExpectedEOFException](index.md)



# ExpectedEOFException  
 [jvm] class [ExpectedEOFException](index.md) : [EOFException](https://docs.oracle.com/javase/8/docs/api/java/io/EOFException.html)   
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#com.kaspersky.adbserver.connection.implementation.transferring/ExpectedEOFException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#com.kaspersky.adbserver.connection.implementation.transferring/ExpectedEOFException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#com.kaspersky.adbserver.connection.implementation.transferring/ExpectedEOFException/message/#/PointingToDeclaration/)|  [jvm] open override val [message](index.md#com.kaspersky.adbserver.connection.implementation.transferring/ExpectedEOFException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
