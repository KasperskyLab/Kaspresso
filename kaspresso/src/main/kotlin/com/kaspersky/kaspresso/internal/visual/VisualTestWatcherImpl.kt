...
internal class VisualTestWatcherImpl(
    ...
    override fun cleanUp() {
        ...
        if (params.testType == VisualTestType.Compare) {
            ...
            if (params.cleanUpAfterTest) {
                files.remove(diffDir.absolutePath)
                files.remove(originalScreenshotsTargetDir.absolutePath)
                files.remove(newScreenshotsDir.absolutePath)
            }
        }
    }
}
