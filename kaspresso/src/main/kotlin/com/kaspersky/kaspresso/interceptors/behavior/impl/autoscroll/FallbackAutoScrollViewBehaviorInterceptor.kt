...
import com.kaspersky.kaspresso.autoscroll.FallbackAutoScrollProviderImpl
 ...
 */
class FallbackAutoScrollViewBehaviorInterceptor(
    params: AutoScrollParams,
    logger: UiTestLogger
) : ViewBehaviorInterceptor,
    AutoScrollProvider<ViewInteraction> by FallbackAutoScrollProviderImpl(params, logger) {
