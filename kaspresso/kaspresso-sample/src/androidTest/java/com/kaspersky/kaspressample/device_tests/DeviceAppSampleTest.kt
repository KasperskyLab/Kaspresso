 ...
 * So, you should run the server with command `cd /absolute/path/to/project/directory/artifacts & java -jar desktop.jar`
 */
class DeviceAppSampleTest : TestCase() {
    ...
    companion object {
         ...
         */
        private const val TEST_APK_FILE_RELATIVE_PATH = "hello_world.apk"
