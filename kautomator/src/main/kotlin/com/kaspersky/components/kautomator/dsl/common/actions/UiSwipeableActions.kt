...
interface UiSwipeableActions : UiBaseActions {
    ...
    fun swipeLeft(percent: Float = 0.95f) {
        view.perform(SwipeableActionType.SWIPE_LEFT) { swipe(Direction.LEFT, percent) }
    }
    ...
    fun swipeRight(percent: Float = 0.95f) {
        view.perform(SwipeableActionType.SWIPE_RIGHT) { swipe(Direction.RIGHT, percent) }
    }
    ...
    fun swipeUp(percent: Float = 0.95f) {
        view.perform(SwipeableActionType.SWIPE_UP) { swipe(Direction.UP, percent) }
    }
    ...
    fun swipeDown(percent: Float = 0.95f) {
        view.perform(SwipeableActionType.SWIPE_DOWN) { swipe(Direction.DOWN, percent) }
    }
