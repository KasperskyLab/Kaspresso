...
> **Внимание!** Будьте осторожны при использовании **performCmd** - исполняемые вами комнды должны поддерживаться всеми возможными хост-машинами. Перед использованием лучше посоветуйтесь с вашей командой: возможно существует решение вашей задачи без использования **performCmd**
