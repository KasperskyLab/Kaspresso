    ...
    Column(
        ...
        if (simpleFlakyState.firstButtonVisibility) {
            Button(
                ...
                content = {
                    Text(text = stringResource(id = R.string.jetpack_compose_simple_flaky_screen_first_button))
                },
        ...
        if (simpleFlakyState.secondButtonVisibility) {
            Button(
                ...
                content = {
                    Text(text = stringResource(id = R.string.jetpack_compose_simple_flaky_screen_second_button))
                },
