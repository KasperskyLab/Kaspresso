 ...
 *
 * Interceptors can be provided through [UiAutomatorDslConfigurator][com.kaspersky.components.uiautomatordsl.UiAutomatorDslConfigurator] runtime,
 * different [UiScreens][com.kaspersky.components.uiautomatordsl.dsl.screen.UiScreen] as well as [UiViews][com.kaspersky.components.uiautomatordsl.dsl.common.views.UiBaseView].
 *
 ...
 * ```
 *
 * @see com.kaspersky.components.uiautomatordsl.UiAutomatorDslConfigurator
 * @see com.kaspersky.components.uiautomatordsl.dsl.screen.UiScreen
 * @see com.kaspersky.components.uiautomatordsl.dsl.common.views.UiBaseView
 */
class UiInterceptor <Interaction, Assertion, Action>(
     ...
     * [UiAutomatorDslConfigurator][com.kaspersky.components.uiautomatordsl.UiAutomatorDslConfigurator] runtime and [UiScreens][com.kaspersky.components.uiautomatordsl.dsl.screen.UiScreen] levels.
     *
     * @see com.kaspersky.components.uiautomatordsl.UiAutomatorDslConfigurator
     * @see com.kaspersky.components.uiautomatordsl.dsl.screen.UiScreen
     */
