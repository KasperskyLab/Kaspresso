...
interface UiBaseAssertions {
     ...
     */
    fun isSelected() {
        view.check(IS_SELECTED) { assertThat(isSelected).isTrue() }
    }
     ...
     */
    fun isNotSelected() {
        view.check(IS_NOT_SELECTED) { assertThat(isSelected).isFalse() }
    }
     ...
     */
    fun isFocused() {
        view.check(IS_FOCUSED) { assertThat(isFocused).isTrue() }
    }
     ...
     */
    fun isNotFocused() {
        view.check(IS_NOT_FOCUSED) { assertThat(isFocused).isFalse() }
    }
     ...
     */
    fun isFocusable() {
        view.check(IS_FOCUSABLE) { assertThat(isFocusable).isTrue() }
    }
     ...
     */
    fun isNotFocusable() {
        view.check(IS_NOT_FOCUSABLE) { assertThat(isFocusable).isFalse() }
    }
     ...
     */
    fun isClickable() {
        view.check(IS_CLICKABLE) { assertThat(isClickable).isTrue() }
    }
     ...
     */
    fun isNotClickable() {
        view.check(IS_NOT_CLICKABLE) { assertThat(isClickable).isFalse() }
    }
     ...
     */
    fun isEnabled() {
        view.check(IS_ENABLED) { assertThat(isEnabled).isTrue() }
    }
     ...
     */
    fun isDisabled() {
        view.check(IS_DISABLED) { assertThat(isEnabled).isFalse() }
    }
